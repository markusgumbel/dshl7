...
/** Implementation of org.hl7.rim.AttentionLine as an abstract decorator, i.e., a class that returns NULL/NA or nothing for all property accessprs amd that raises UnsupportedOperationExceptions for all mutators. This is used to adapt custom application classes to the RIM class interfaces and only bother about mapping those properties that actually apply to the application class. This can be done in one of two ways: (1) the client class can extend the decorator directly, and implement the applicable properties, or (2) the abstract decorator can be extend to a concrete decorator, which would hold a reference to the client object and method bodies to delegate and adapt the applicable properties.
  ...
  */
public abstract class AttentionLineDecorator extends org.hl7.rim.decorators.InfrastructureRootDecorator implements AttentionLine {
  /** Property accessor, returns NULL/NA if not overloaded.keyWordText.
      @see org.hl7.rim.AttentionLine#getKeyWordText
  */
  public SC getKeyWordText() { return SCnull.NI; /* should be NA, but that causes trouble for string-literal hibernated properties. */ }
  ...
  */
  public org.hl7.rim.Transmission getTransmission() { return null; }
  /** Property mutator, does nothing if not overloaded.transmission.
      @see org.hl7.rim.AttentionLine#setTransmission
  */
  public void setTransmission(org.hl7.rim.Transmission transmission) { /* throw new UnsupportedOperationException(); */ }
}
