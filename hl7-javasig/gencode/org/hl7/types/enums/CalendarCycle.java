...
public enum CalendarCycle implements CS {
  ...
  /**  */
  Day(TwoLetter, "Day (continuous)", "CD", "day (continuous)"),
  /**  */
  DayOfTheMonth(OneLetter, TwoLetter, "Day of the month", "DM", "day of the month"),
  /**  */
  DayOfTheWeek(OneLetter, TwoLetter, "Day of the week (begins with Monday)", "DW", "day of the week (begins with Monday)"),
  /**  */
  DayOfTheYear(TwoLetter, "Day of the year", "DY", "day of the year"),
  /**  */
  Hour(TwoLetter, "Hour (continuous)", "CH", "hour (continuous)"),
  /**  */
  HourOfTheDay(OneLetter, TwoLetter, "Hour of the day", "HD", "hour of the day"),
  /**  */
  Minute(TwoLetter, "Minute (continuous)", "CN", "minute (continuous)"),
  /**  */
  MinuteOfTheHour(OneLetter, TwoLetter, "Minute of the hour", "NH", "minute of the hour"),
  /**  */
  Month(TwoLetter, "Month (continuous)", "CM", "month (continuous)"),
  /**  */
  MonthOfTheYear(OneLetter, TwoLetter, "Month of the year", "MY", "month of the year"),
  /**  */
  Second(TwoLetter, "Second (continuous)", "CS", "second (continuous)"),
  /**  */
  SecondOfTheMinute(OneLetter, TwoLetter, "Second of the minute", "SN", "second of the minute"),
  /**  */
  Week(OneLetter, TwoLetter, "Week (continuous)", "CW", "week (continuous)"),
  /**  */
  WeekOfTheYear(TwoLetter, "Week of the year", "WY", "week of the year"),
  /**  */
  Year(OneLetter, TwoLetter, "Year", "CY", "year");
  ...
  private final CalendarCycle _parent3; // well, found a 3rd :(
  ...
  // duh! what a cheap way to make a set, but really we don't expect there to be too many more than 2 parents!
  private CalendarCycle(CalendarCycle parent, CalendarCycle parent2, CalendarCycle parent3, String domainName, String code, String displayName) {
    _parent = parent;
    _parent2 = parent2;
    _parent3 = parent3;
