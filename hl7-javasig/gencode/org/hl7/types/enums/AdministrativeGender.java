...
public enum AdministrativeGender implements CS {
  ...
  /** Female */
  Female(null, "Female", "F", "Female"),
  /** Male */
  Male(null, "Male", "M", "Male"),
  /** The gender of a person could not be uniquely defined as male or female, such as hermaphrodite. */
  Undifferentiated(null, "Undifferentiated", "UN", "Undifferentiated");
  ...
  private final AdministrativeGender _parent3; // well, found a 3rd :(
  ...
  // duh! what a cheap way to make a set, but really we don't expect there to be too many more than 2 parents!
  private AdministrativeGender(AdministrativeGender parent, AdministrativeGender parent2, AdministrativeGender parent3, String domainName, String code, String displayName) {
    _parent = parent;
    _parent2 = parent2;
    _parent3 = parent3;
