...
public enum ResponseModality implements CS {
  ...
  private final ResponseModality _parent3; // well, found a 3rd :(
  ...
  // duh! what a cheap way to make a set, but really we don't expect there to be too many more than 2 parents!
  private ResponseModality(ResponseModality parent, ResponseModality parent2, ResponseModality parent3, String domainName, String code, String displayName) {
    _parent = parent;
    _parent2 = parent2;
    _parent3 = parent3;
