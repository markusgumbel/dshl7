...
/** Codes representing the defined possible states of an Entity, as defined by the Entity class state machine.<p>This table controls values for structural elements of the HL7 Reference Information Model. Therefore, it is part of the Normative
   Ballot for the RIM.
</p> */
...
in error. */
  ...
  private final EntityStatus _parent3; // well, found a 3rd :(
  ...
  // duh! what a cheap way to make a set, but really we don't expect there to be too many more than 2 parents!
  private EntityStatus(EntityStatus parent, EntityStatus parent2, EntityStatus parent3, String domainName, String code, String displayName) {
    _parent = parent;
    _parent2 = parent2;
    _parent3 = parent3;
