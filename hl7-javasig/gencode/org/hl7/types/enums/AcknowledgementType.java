...
public enum AcknowledgementType implements CS {
  ...
  AcceptAcknowledgementCommitAccept(null, "Accept Acknowledgement Commit Accept", "CA", "Accept Acknowledgement Commit Accept"),
  /** Receiving message handling service cannot accept message for any other reason (e.g. message sequence number, etc.). */
  AcceptAcknowledgementCommitError(null, "Accept Acknowledgement Commit Error", "CE", "Accept Acknowledgement Commit Error"),
...
known receiving application role information. */
  AcceptAcknowledgementCommitReject(null, "Accept Acknowledgement Commit Reject", "CR", "Accept Acknowledgement Commit Reject"),
  /** Receiving application successfully processed message. */
  ApplicationAcknowledgementAccept(null, "Application Acknowledgement Accept", "AA", "Application Acknowledgement Accept"),
  /** Receiving application found error in processing message. Sending error response with additional error detail information. */
  ApplicationAcknowledgementError(null, "Application Acknowledgement Error", "AE", "Application Acknowledgement Error"),
...
on whether to automatically send message again. */
  ApplicationAcknowledgementReject(null, "Application Acknowledgement Reject", "AR", "Application Acknowledgement Reject");
  ...
  private final AcknowledgementType _parent3; // well, found a 3rd :(
  ...
  // duh! what a cheap way to make a set, but really we don't expect there to be too many more than 2 parents!
  private AcknowledgementType(AcknowledgementType parent, AcknowledgementType parent2, AcknowledgementType parent3, String domainName, String code, String displayName) {
    _parent = parent;
    _parent2 = parent2;
    _parent3 = parent3;
