...
public enum ResponseLevel implements CS {
  ...
  Completion(null, "Completion", "C", "completion"),
...
any application-level detail */
  ...
  private final ResponseLevel _parent3; // well, found a 3rd :(
  ...
  // duh! what a cheap way to make a set, but really we don't expect there to be too many more than 2 parents!
  private ResponseLevel(ResponseLevel parent, ResponseLevel parent2, ResponseLevel parent3, String domainName, String code, String displayName) {
    _parent = parent;
    _parent2 = parent2;
    _parent3 = parent3;
