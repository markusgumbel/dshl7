...
an automated announcement. */
  AnsweringService(null, "Answering service", "AS", "answering service"),
  /** A contact specifically designated to be used for emergencies. This is the first choice in emergencies, independent of any
other use codes. */
  EmergencyContact(null, "Emergency contact", "EC", "emergency contact"),
...
for urgent matters, not the first choice for routine business. */
  ...
  private final TelecommunicationAddressUse _parent3; // well, found a 3rd :(
  ...
  // duh! what a cheap way to make a set, but really we don't expect there to be too many more than 2 parents!
  private TelecommunicationAddressUse(TelecommunicationAddressUse parent, TelecommunicationAddressUse parent2, TelecommunicationAddressUse parent3, String domainName, String code, String displayName) {
    _parent = parent;
    _parent2 = parent2;
    _parent3 = parent3;
