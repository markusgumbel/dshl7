...
/**
 * This class defines unit test for TS.
 *
 ...
 */
public class TSTest extends XMLTestCase
{
	/**
	...
	private static Datatype datatype = new SimpleDatatypeImpl("TS");
	...
	public void testTS_01() throws Exception
	{
//		final String input = "<characterString xmlns=\"" + HL7_URI + "\" representation=\"TXT\" code=\"30971-6\" codeSystem=\"2.16.840.1.113883.19\" codeSystemVersion=\"2.13\" codeSystemName=\"LONIC\" displayName=\"ADVERSE EVENT\"/>";
		final String input = "<pointInTime xmlns=\"" + HL7_URI + "\" value=\"20000131183828.789\"></pointInTime>";
		final String output = "<pointInTime xmlns=\"" + HL7_URI + "\" value=\"20000131183828.789\"></pointInTime>";
		InputStream is = new ByteArrayInputStream(input.getBytes());
		TS value = (TS) StandaloneDataTypeContentHandler.parseValue(is, datatype);
		String fromXML = getXMLForValue(value, "pointInTime");
