...
/**
 * This class defines unit test for ST.
 *
 ...
 */
public class STTest extends XMLTestCase
{
	/**
	...
	private static Datatype datatype = new SimpleDatatypeImpl("ST");
	...
	public void testST_01() throws Exception
	{
//		final String input = "<characterString xmlns=\"" + HL7_URI + "\" representation=\"TXT\" code=\"30971-6\" codeSystem=\"2.16.840.1.113883.19\" codeSystemVersion=\"2.13\" codeSystemName=\"LONIC\" displayName=\"ADVERSE EVENT\"/>";
		final String input = "<characterString xmlns=\"" + HL7_URI + "\" representation=\"TXT\">Health Level Seven</characterString>";
		final String output = "<characterString xmlns=\"" + HL7_URI + "\" representation=\"TXT\">Health Level Seven</characterString>";
		InputStream is = new ByteArrayInputStream(input.getBytes());
		ST value = (ST) StandaloneDataTypeContentHandler.parseValue(is, datatype);
		String fromXML = getXMLForValue(value, "characterString");
