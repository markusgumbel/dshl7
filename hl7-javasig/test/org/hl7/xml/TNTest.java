...
/**
 * This class defines unit test for TN.
 *
 ...
 */
public class TNTest extends XMLTestCase
{
	/**
	...
	private static Datatype datatype = new SimpleDatatypeImpl("TN");
	...
	public void testTN_01() throws Exception
	{
		final String input  = "<name xmlns=\"" + HL7_URI + "\">" + "Washington-Reagan National Airport</name>";
		final String output = input;
		InputStream is = new ByteArrayInputStream(input.getBytes());
		TN value = (TN) StandaloneDataTypeContentHandler.parseValue(is, datatype);
	...
	public void testTN_02() throws Exception
	{
		final String input  = "<name xmlns=\"" + HL7_URI + "\" use=\"A\">" + "Washington-Reagan National Airport</name>";
		final String output = input;
		InputStream is = new ByteArrayInputStream(input.getBytes());
		TN value = (TN) StandaloneDataTypeContentHandler.parseValue(is, datatype);
		String fromXML = getXMLForValue(value, "name");
