...
/**
 * This class defines unit test for II.
 *
 ...
 */
public class IITest extends XMLTestCase
{
	/**
	...
	private static Datatype datatype = new SimpleDatatypeImpl("II");
	...
	public void testII_01() throws Exception
	{
		//<originalText mediaType = "text/plain" representation = "TXT" > O </originalText >
		final String input = "<id xmlns=\"" + HL7_URI + "\" " + "assigningAuthorityName=\"String\" root=\"Text\" displayable=\"true\" extension=\"String\"/>";
		final String output = "<id xmlns=\"" + HL7_URI + "\" " + "assigningAuthorityName=\"String\" root=\"Text\" displayable=\"true\" extension=\"String\"/>";
		InputStream is = new ByteArrayInputStream(input.getBytes());
		II value = (II) StandaloneDataTypeContentHandler.parseValue(is, datatype);
		String fromXML = getXMLForValue(value, "id");
		DetailedDiff detailedDiff = doDiff(output, fromXML, new ElementNameAndAttributeQualifier());
