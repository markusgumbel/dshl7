...
/**
 * This class defines unit test for ENXP.
 *
 ...
 */
public class ENXPTest extends XMLTestCase
{
	/**
	...
	private static Datatype datatype = new SimpleDatatypeImpl("ENXP");
	...
	public void testENXP_01() throws Exception
	{
		//<originalText mediaType = "text/plain" representation = "TXT" > O </originalText >
		final String input = "<entityEntry xmlns=\"" + HL7_URI + "\">" + "John Doe Smith</entityEntry>";
		final String output = "<entityEntry xmlns=\"" + HL7_URI + "\">" + "John Doe Smith</entityEntry>";
		InputStream is = new ByteArrayInputStream(input.getBytes());
		ENXP value = (ENXP) StandaloneDataTypeContentHandler.parseValue(is, datatype);
		String fromXML = getXMLForValue(value, "entityEntry");
